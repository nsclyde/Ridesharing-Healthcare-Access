...
temp2=temp[,c("Tot_Clms","Tot_Benes","Bene_Avg_Risk_Scre","avg_pre_dual","Prscrbr_City","yearindicator")]
...
column2 = felm(Tot_Clms ~  I(treatment_group*AfterReentry)+ I(I(treatment_group*AfterReentry)*st_avg_pre_risk) + Bene_Avg_Risk_Scre|PRSCRBR_NPI + yearindicator|0|PRSCRBR_NPI, data=subset(uber_providers,similar_to_austin==1 & is.na(st_avg_pre_risk)==FALSE))
...
column4 = felm(Tot_Clms ~  I(treatment_group*AfterReentry) + I(I(treatment_group*AfterReentry)*avg_pre_dual) + Bene_Avg_Risk_Scre|PRSCRBR_NPI + yearindicator|0|PRSCRBR_NPI, data=subset(uber_providers,similar_to_austin==1 & is.na(avg_pre_dual)==FALSE))
...
stargazer(column1,column2, column3, column4, digits=2, no.space=TRUE, p.auto=TRUE, single.row=FALSE, omit.stat=c("ser", "adj.rsq","rsq"),
          add.lines = list(
                           ...
                           c('Provider fixed effects', 'Yes','Yes','Yes','Yes', 'Yes','Yes')), type="text")
...
column2 = felm(Tot_Clms ~ I(treatment_group*AfterReentry) + I(I(treatment_group*AfterReentry)*st_risk_2015) + Bene_Avg_Risk_Scre|PRSCRBR_NPI + yearindicator|0|PRSCRBR_NPI, data=subset(uber_providers,similar_to_austin==1 & is.na(st_risk_2015)==FALSE))
...
column4 = felm(Tot_Clms ~I(treatment_group*AfterReentry) + I(I(treatment_group*AfterReentry)*dual_2015) + Bene_Avg_Risk_Scre|PRSCRBR_NPI + yearindicator|0|PRSCRBR_NPI, data=subset(uber_providers,similar_to_austin==1 & is.na(dual_2015)==FALSE))
...
column4 = felm(Tot_Clms ~ I(treatment_group*AfterReentry) + I(I(treatment_group*AfterReentry)*Urban) + Bene_Avg_Risk_Scre|PRSCRBR_NPI + yearindicator|0|PRSCRBR_NPI, data=subset(uber_filtered,similar_to_austin==1 & switching==0))
...
stargazer(column1,column2, column3,  column4, digits=2, no.space=TRUE, p.auto=TRUE, single.row=FALSE, omit.stat=c("ser", "adj.rsq","rsq"),
          add.lines = list(
                           ...
                           c('Provider fixed effects', 'Yes','Yes','Yes','Yes')), type="text")
